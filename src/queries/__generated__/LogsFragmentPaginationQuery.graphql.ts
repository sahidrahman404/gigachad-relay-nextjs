/**
 * @generated SignedSource<<f939919a6de883840b0f6a2b4774578e>>
...
export type LogsFragmentPaginationQuery$variables = {
  count?: number | null | undefined;
  cursor?: any | null | undefined;
  id: string;
  orderby?: OrderDirection | null | undefined;
};
export type LogsFragmentPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"LogsFragment">;
  } | null | undefined;
};
export type LogsFragmentPaginationQuery = {
  response: LogsFragmentPaginationQuery$data;
  variables: LogsFragmentPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "LogsFragmentPaginationQuery",
    "selections": [
      {
        "alias": null,
        "args": (v4/*: any*/),
  ...
  "params": {
    "cacheID": "59bb5b381bf66e715a4b9bd6a7c46755",
    "id": null,
    "metadata": {},
    "name": "LogsFragmentPaginationQuery",
    "operationKind": "query",
    "text": "query LogsFragmentPaginationQuery(\n  $count: Int = 4\n  $cursor: Cursor\n  $orderby: OrderDirection = DESC\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...LogsFragment_2GViAS\n    id\n  }\n}\n\nfragment ImageFragment on Image {\n  src\n  srcset\n  width\n  height\n  priority\n  loading\n  fetchPriority\n  decoding\n  layout\n  aspectRatio\n  objectFit\n  breakpoints\n  alt\n  role\n  sizes\n  style {\n    aspectRatio\n    height\n    maxHeight\n    maxWidth\n    width\n  }\n}\n\nfragment LogCardFragment on Workout {\n  id\n  name\n  volume\n  duration\n  sets\n  createdAt\n  image {\n    ...ImageFragment\n  }\n  description\n  users {\n    unit\n    id\n  }\n  workoutLogs(orderBy: {direction: ASC, field: Order}) {\n    edges {\n      node {\n        id\n        sets {\n          reps\n          weight\n          duration\n          length\n        }\n        exercises {\n          name\n          image {\n            ...ImageFragment\n          }\n          id\n        }\n      }\n    }\n  }\n}\n\nfragment LogsFragment_2GViAS on User {\n  id\n  workouts(after: $cursor, first: $count, orderBy: {direction: $orderby, field: ID}) {\n    edges {\n      node {\n        id\n        ...LogCardFragment\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n}\n"
  }
};
})();
