...
export type RoutinesEmptyStateFragmentRefetchQuery = {
  ...
  variables: RoutinesEmptyStateFragmentRefetchQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "RoutinesEmptyStateFragmentRefetchQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    "cacheID": "9ba4bf6b6f6e6f9ef25516cd879d7a0b",
    "id": null,
    "metadata": {},
    "name": "RoutinesEmptyStateFragmentRefetchQuery",
    "operationKind": "query",
    "text": "query RoutinesEmptyStateFragmentRefetchQuery(\n  $count: Int = 1\n  $cursor: Cursor\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...RoutinesEmptyStateFragment_1G22uz\n    id\n  }\n}\n\nfragment RoutinesEmptyStateFragment_1G22uz on User {\n  exercises(after: $cursor, first: $count) {\n    edges {\n      node {\n        id\n        name\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n  id\n}\n"
  }
};
})();
